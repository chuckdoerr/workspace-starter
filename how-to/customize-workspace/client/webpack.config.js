...
const configs = [
	...
	{
		entry: './client/src/common/windows/hidden-window/hidden.ts',
		devtool: 'inline-source-map',
		module: {
			rules: [
				{
	...
	{
		entry: './client/src/common/windows/irs-rfq/irs-rfq.ts',
		devtool: 'inline-source-map',
		module: {
			rules: [
				{
	...
	{
		entry: './client/src/common/views/template/index.ts',
		devtool: 'inline-source-map',
		module: {
			rules: [
				{
	...
	{
		entry: './client/src/common/windows/intent-window/intent-snapshot-launcher.ts',
		devtool: 'inline-source-map',
		module: {
			rules: [
				{
