...
Want to integrate using our integration modules or even integrate with something that doesn't require an OpenFin integration? A platform is web based and any integration that would work in a browser would work here (e.g. REST services).
...
We also offer some integrations as samples for other providers, these are **not** officially supported.

| Example                                                                                          | Description                                                                                                                   | Live Launch |
| ------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------- | ----------- |
| [How To Integrate With Google Workspaces Basic](./how-to/integrate-with-google-workspaces-basic) | This basic example demonstrates how to connect to Google Workspaces using OAuth and perform a query.                          |             |
